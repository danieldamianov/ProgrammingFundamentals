...
namespace EXERCISES_6._Advertisement_Message
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numMesseages; i++)
            {
                ...
                File.AppendAllText("output.txt",$"{basePhrases[posPhrases]} {baseEvents[posEvents]} {baseAuthors[posAuthors]} – {baseCities[posCitirs]}." + Environment.NewLine);
            }
        }
    }
}
